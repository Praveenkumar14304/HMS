...
<body>
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-left position-relative"
            style="background:url(../assets/images/big/hmsbg-bg.jpg) no-repeat center center;">
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(assets/images/hotel-img.jpeg);">
                </div>
                <div class="col-lg-5 col-md-7 bg-grey">
                    <div class="p-3">
